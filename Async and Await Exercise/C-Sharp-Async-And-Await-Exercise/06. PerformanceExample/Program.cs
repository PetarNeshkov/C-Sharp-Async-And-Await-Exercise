...
namespace _06._PerformanceExample
{
    public class Program
    {
        private const int NumberOfCpus = 12;

        private const string ImagesDirectory =
            @"C:\Data\Projects\Code It Up\Source\1. C# Async-Await In Detail\6. PerformanceExample\Images";
        ...
        public async Task ResizeCpuAsynchronously()
        {
            ...
            foreach (var file in files)
            {
                ...
                await Task.Run(() => { ProcessImage(file, dir + $"{fileInfo.Name}"); });
            }
        ...
        public async Task ResizeCpuAsynchronouslyMultipleTasks()
        {
            ...
            foreach (var file in files)
            {
                ...
                tasks.Add(Task.Run(() => { ProcessImage(file, dir + $"{fileInfo.Name}"); }));
            }
